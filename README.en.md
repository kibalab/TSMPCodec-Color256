...
2. Open the Codec tab in `TSMPSetup` and select `Color256` from the automatically discovered codecs.
...
Color256 2.0.0 is a stable release consolidating all beta changes since 1.0.0. Install Core 1.0.0 first. VCC does not require prerelease packages for these versions.
